...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        URL githubSearchUrl = NetworkUtils.buildUrl(githubQuery.trim());
    ...
    class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        @Override
        protected void onPostExecute(final String githubSearchResults) {
            if(null != githubSearchResults && !githubSearchResults.equals("")) {
